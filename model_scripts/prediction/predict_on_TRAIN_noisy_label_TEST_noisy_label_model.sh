...
python model_scripts/training/run_summarization.py \
    --model_name_or_path model_outputs/trained_t5_large_model_neural_net \
    --config_name model_outputs/trained_t5_large_model_neural_net/config.json \
    --training_dataset_name noisy_label \
    --prediction_dataset_name noisy_label \
    --do_predict \
    --test_file data_files/noisy_label/abstracts_introductions_test_split.csv \
    --source_prefix "summarize: " \
    --output_dir model_outputs/trained_t5_large_model_neural_net \
