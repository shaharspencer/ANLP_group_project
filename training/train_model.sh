...
python /cs/snapless/gabis/shaharspencer/ANLP_group_project/training/run_summarization.py \
    ...
    --do_eval \
    --do_predict \
    --train_file /cs/snapless/gabis/shaharspencer/ANLP_group_project/data_files/neural_net/abstracts_introductions_train_split.csv \
    --validation_file /cs/snapless/gabis/shaharspencer/ANLP_group_project/data_files/neural_net/abstracts_introductions_validation_split.csv \
